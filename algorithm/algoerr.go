...
// ErrEdgeTooFewPoint ...
var ErrEdgeTooFewPoint = fmt.Errorf("Edge must have >= 2 points")

// ErrEdgeEndPointEqual ...
var ErrEdgeEndPointEqual = fmt.Errorf("Edge direction cannot be determined because endpoints are equal")
